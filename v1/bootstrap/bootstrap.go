...
func PrepareBootstrapTransactions(validatorAppId int, asset1ID int, asset2ID int, asset1UnitName string, asset2UnitName string, sender []byte, suggestedParams types.SuggestedParams) (txnGroup utils.TransactionGroup, err error) {
